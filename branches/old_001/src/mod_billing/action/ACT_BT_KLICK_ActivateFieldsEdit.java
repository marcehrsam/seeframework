...
public class ACT_BT_KLICK_ActivateFieldsEdit extends AbstractAction {
	...
	private GUI_DIALOG_EditBill dialog = null;
	
	public final String ACTIVATE = "Rechnungsdaten ändern";
	
	public ACT_BT_KLICK_ActivateFieldsEdit(GUI_DIALOG_EditBill dialog){
